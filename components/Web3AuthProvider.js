...
// Web3AuthProvider component that provides login, logout, and Web3Auth functionalities
    ...
    const initWeb3Auth = async () => {
      try {
        const web3authInstance = new Web3Auth({
          clientId: process.env.NEXT_PUBLIC_WEB3AUTH_CLIENT_ID, // Client ID from environment variable
          chainConfig: { chainNamespace: "eip155", chainId: "0x1" }, // Ethereum Mainnet configuration
        });
